# Web Scraping and Q & A Tutorial

## What you need:
- openAI API key
- Python
- If you want to skip the implementation download this: [link](https://github.com/openai/web-crawl-q-and-a-example)

Open your IDE get a project going and start with this
